				...
				<section className="w-full h-full">
					<div className="w-full h-[68px] flex justify-between items-center md:h-[114px]  ">
						<div className="flex flex-col justify-between h-full">
							<h1
								...
								} text-[32px] leading-[32px] text-black3 dark:text-white1 md:text-[64px] md:leading-[77px] `}
							>
								{word?.word}
							</h1>
					...
					<footer className="border-t border-white3 pt-[24px] mt-[30px] pb-[85px] mb:pb-[118px] md:flex md:gap-[20px] ">
						...
						<a
							...
							className="flex"
						>
							<span className="text-[14px] leading-[17px] underline text-black3 dark:text-white1 mr-[15px] md:mr-[10px] ">
								{word?.sourceUrls[0]}
							</span>
							<img
